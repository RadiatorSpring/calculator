...
public class ExceptionMessages {
    ...
    public static final String ILLEGAL_ARGUMENT_EXCEPTION_MESSAGE = "There cannot be letters nor spaces between digits and there should be at least 2 operands and 1 operator";
