...
//                processMessageAndStatusCode(CANNOT_DIVIDE_BY_ZERO, 400, response);
//            } catch (IllegalArgumentException e) {
//                processMessageAndStatusCode(ILLEGAL_ARGUMENT_EXCEPTION_MESSAGE, 400, response);
//            } catch (EmptyStackException e) {
//                processMessageAndStatusCode(EMPTY_STACK_EXCEPTION_MESSAGE, 400, response);
//            } catch (Exception e) {
//                processMessageAndStatusCode(GENERAL_EXCEPTION_MESSAGE, 500, response);
//            }
//        } else {
//            processMessageAndStatusCode(EMPTY_PARAMETER_EXCEPTION, 400, response);
//        }
//    }
//
