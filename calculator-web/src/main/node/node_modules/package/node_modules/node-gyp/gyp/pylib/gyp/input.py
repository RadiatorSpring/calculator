...
def LoadTargetBuildFile(build_file_path, data, aux_data, variables, includes,
  ...
  # Apply "pre"/"early" variable expansions and condition evaluation.
...
# makes sense to cache as much as possible between evaluation.
...
def ProcessVariablesAndConditionsInDict(the_dict, phase, variables_in,
  ...
  conditional evaluation.  The variables_in dictionary will not be modified
  by this function.
  """
...
def SetUpConfigurations(target, target_dict):
  ...
  # These suffixes are handled in conditional evaluation (for =, +, and ?)
...
def Load(build_files, variables, includes, depth, generator_input_info, check,
  ...
  # Apply "post"/"late"/"target" variable expansions and condition evaluation.
  for target in flat_list:
    target_dict = targets[target]
    build_file = gyp.common.BuildFile(target)
    ProcessVariablesAndConditionsInDict(
  ...
  # Apply "latelate" variable expansions and condition evaluation.
  for target in flat_list:
    target_dict = targets[target]
    build_file = gyp.common.BuildFile(target)
    ProcessVariablesAndConditionsInDict(
