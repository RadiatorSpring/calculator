...
//
//    @Test
//    public void testCalculatorServletEmptyStackException() throws CannotDivideByZeroException, IOException {
//        errorCasesRunner(EMPTY_STACK_EXCEPTION_MESSAGE, SC_BAD_REQUEST, "1*-1", EmptyStackException.class);
//    }
//
//    @Test
//    public void testCalculatorServletCannotDivideByZero() throws CannotDivideByZeroException, IOException {
//        errorCasesRunner(CANNOT_DIVIDE_BY_ZERO, SC_BAD_REQUEST, "1/0", CannotDivideByZeroException.class);
//    }
//
//    @Test
//    public void testCalculatorServletIllegalArgumentException() throws CannotDivideByZeroException, IOException {
//        errorCasesRunner(ILLEGAL_ARGUMENT_EXCEPTION_MESSAGE, SC_BAD_REQUEST, "aqefdgb", IllegalArgumentException.class);
//    }
//
//    @Test
//    public void testCalculatorServletEmptyParameterException() throws CannotDivideByZeroException, IOException {
//        errorCasesRunner(EMPTY_PARAMETER_EXCEPTION, SC_BAD_REQUEST, "", EmptyStackException.class);
//    }
//
//    private void errorCasesRunner(String message, int code, String expression, Class<? extends Exception> e) throws CannotDivideByZeroException, IOException {
//
