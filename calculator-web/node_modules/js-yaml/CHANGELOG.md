...
- Ensure stack is present for custom models.errors in node 7.+, #351.
...
- Fix reported position for `duplicated mapping key` models.errors.
...
- Fixed stacktrace handling in generated models.errors, for browsers (FF/IE).
