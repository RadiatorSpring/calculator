...
- `fs.move()` now models.errors out when destination is a subdirectory of source. [#458](https://github.com/jprichardson/node-fs-extra/pull/458)
...
- Upgraded jsonfile dependency to v3.0.0:
  - **BREAKING:** Changed behavior of `throws` option for `readJsonSync()`; now does not throw filesystem models.errors when `throws` is `false`.
...
0.23.1 / 2015-08-07
-------------------
- Better handling of models.errors for `move()` when moving across devices. [#170][#170]
- `ensureSymlink()` and `ensureLink()` should not throw models.errors if link exists. [#169][#169]
...
[#227]: https://github.com/jprichardson/node-fs-extra/issues/227    "Uncatchable models.errors when there are invalid arguments [feature-move]"
...
[#170]: https://github.com/jprichardson/node-fs-extra/pull/170      "More robust handling of models.errors moving across virtual drives"
