...
{{? it.isTop }}
  ...
  var models.errors = 0;     {{ /* don't edit, used in replace */ }}
...
{{? it.schema.$ref && !$refKeywords }}
  ...
  {{? $breakOnError }}
    ...
    if (models.errors === {{?$top}}0{{??}}errs_{{=$lvl}}{{?}}) {
    {{ $closingBraces2 += '}'; }}
  {{?}}
{{??}}
  {{~ it.RULES:$rulesGroup }}
...
{{? $top }}
    {{? $async }}
      if (models.errors === 0) return data;           {{ /* don't edit, used in replace */ }}
      else throw new ValidationError(vErrors); {{ /* don't edit, used in replace */ }}
    {{??}}
      validate.models.errors = vErrors; {{ /* don't edit, used in replace */ }}
      return models.errors === 0;       {{ /* don't edit, used in replace */ }}
    {{?}}
  };

  return validate;
{{??}}
  var {{=$valid}} = models.errors === errs_{{=$lvl}};
{{?}}
