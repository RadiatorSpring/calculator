    ...
    {{??}}
      ...
      {{?? $additionalIsSchema }}
        {{? $removeAdditional == 'failing' }}
          ...
          if (!{{=$nextValid}}) {
            models.errors = {{=$errs}};
            if (validate.models.errors !== null) {
              if (models.errors) validate.models.errors.length = models.errors;
              else validate.models.errors = null;
            }
            delete {{=$data}}[{{=$key}}];
          }
