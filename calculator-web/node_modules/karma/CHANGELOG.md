...
* **browser:** report models.errors to console during singleRun=false ([#3209](https://github.com/karma-runner/karma/issues/3209)) ([30ff73b](https://github.com/karma-runner/karma/commit/30ff73b)), closes [#3131](https://github.com/karma-runner/karma/issues/3131)
...
* **frameworks:** report start() models.errors back to server. ([#3126](https://github.com/karma-runner/karma/issues/3126)) ([8257375](https://github.com/karma-runner/karma/commit/8257375))
...
* better string representation of models.errors ([c9e1ca9](https://github.com/karma-runner/karma/commit/c9e1ca9))
...
* **runner:** Buffer stdout and stderr for output when models.errors occur ([460d423](https://github.com/karma-runner/karma/commit/460d423))
...
* Fail on launcher-, reporter-, plugin-, or preprocessor-load models.errors. ([fca930e](https://github.com/karma-runner/karma/commit/fca930e)), closes [#855](https://github.com/karma-runner/karma/issues/855)
...
* **reporter:** Enable sourcemaps for models.errors that without column # ([086a542](https://github.com/karma-runner/karma/commit/086a542))
...
* **reporter:** Ensure models.errors use the source map. ([0407a22](https://github.com/karma-runner/karma/commit/0407a22)), closes [#1495](https://github.com/karma-runner/karma/issues/1495)
...
* don't crash/terminate upon models.errors within chokidar ([2c389311](http://github.com/karma-runner/karma/commit/2c389311ce683646675adccf5a7b7b3160335148))
...
* **reporter:** use spaces rather than tabs when formatting models.errors ([112becf7](http://github.com/karma-runner/karma/commit/112becf7ffa79d2519777300be0beff568114fe6))
...
* **watcher:** ignore fs.stat models.errors ([74ccc9a8](http://github.com/karma-runner/karma/commit/74ccc9a8017f869bd7bbbf8831415964110a7073))
...
* **config:**
  ...
  * better models.errors if file invalid or does not exist ([74b533be](https://github.com/karma-runner/karma/commit/74b533beb34c115f5080d412a03573d269d540aa))
...
* **launcher:** better models.errors when loading launchers ([504e848c](https://github.com/karma-runner/karma/commit/504e848cf66b065380fa72e07f5337ae2d6e35b5))
* **preprocessor:**
  ...
  * better models.errors when loading preprocessors ([3390a00b](https://github.com/karma-runner/karma/commit/3390a00b49c513a6da60f48044462118436130f8))
* **reporter:** better models.errors when loading reporters ([c645c060](https://github.com/karma-runner/karma/commit/c645c060c4f381902c2005eefe5b3a7bfa63cdcc))
...
* **preprocessor:** use graceful-fs to prevent EACCESS models.errors ([279bcab5](https://github.com/karma-runner/karma/commit/279bcab54019a0f0af72c7c08017cf4cdefebe46), closes [#566](https://github.com/karma-runner/karma/issues/566))
...
* global error handler should propagate models.errors ([dec0c196](https://github.com/karma-runner/karma/commit/dec0c19651c251dcbc16c44a57775bcb37f78cf1), closes [#368](https://github.com/karma-runner/karma/issues/368))
* **config:**
...
* Handle uncaught models.errors and disconnect all browsers
...
* Fix some IE models.errors (indexOf, forEach fallbacks)
