...
2014-02-02
 ...
 - Fix a nasty bug causing syntax models.errors when selector interpolation is preceded by a long comment (and some other cases)
 ...
 - Round numbers to 8 decimal places - thereby stopping javascript precision models.errors
...
2014-01-01
 ...
 - Fixed line/column numbers from math models.errors
...
2013-10-21
 ...
 - Browser: added logLevel option to control logging (2 = everything, 1 = models.errors only, 0 = no logging)
...
2013-04-30
 ...
 - exception models.errors extend the JavaScript Error
...
2013-03-07
 ...
 - lessc "-lint" option just reports models.errors
