...
// Errors (both immediate and async write models.errors) can be detected in an optional
...
// Immediate models.errors can also be handled with `try...catch`, but **note** that
