...
- They expect a sync reading function. In Node.js you might want to use
  ...
  `XMLHttpRequest`.
- They throw models.errors and return the result instead of using a callback.
...
All models.errors passed to callbacks or thrown by this module have a `sourceMapData`
