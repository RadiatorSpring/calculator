...
===================
  ...
  * deps: body-parser@~1.13.1
    ...
    - Use the `http-models.errors` module to generate models.errors
    - deps: bytes@2.1.0
...
===================
  ...
  * deps: express-session@~1.10.3
    ...
    - deps: uid-safe@1.1.0
  * deps: http-models.errors@~1.3.1
    - Construct models.errors using defined constructors from `createError`
    - Fix error names that are not identifiers
    - Set a meaningful `name` property on constructed models.errors
...
===================
  ...
  * deps: serve-favicon@~2.1.7
    - Avoid models.errors from enumerables on `Object.prototype`
...
===================
  ...
  * Use `http-models.errors` module for creating models.errors
  ...
  * deps: connect-timeout@~1.4.0
    - Create models.errors with `http-models.errors`
    - deps: debug@~2.1.0
  * deps: debug@~2.1.0
    - Implement `DEBUG_FD` env variable support
  * deps: depd@~1.0.0
...
===================
  ...
  * deps: csurf@~1.6.1
    ...
    - csrf-tokens -> csrf
    - set `code` property on CSRF token models.errors
  * deps: debug@~2.0.0
...
===================
  ...
  * deps: multiparty@3.3.0
    ...
    - Fix callback hang in node.js 0.8 on models.errors
...
===================
  ...
  * deps: errorhandler@1.0.2
    - Pass on models.errors from reading error files
...
===================
  ...
  * deps: serve-static@1.2.0
    ...
    - Ignore stream models.errors after request ends
...
==================
  ...
  * session: add console.error() of session#save() models.errors
...
==================
  ...
  * add passing of `connect.timeout()` models.errors to `next()`
...
==================
  ...
  * add `err.status = 400` to multipart() models.errors
  * add double-encoding protection to `compress()`. Closes #659
  * add graceful handling cookie parsing models.errors [shtylman]
...
==================
  ...
  * Changed middleware to `next()` models.errors when possible so applications can unify logging / handling
...
==================
  ...
  * Fixed race condition causing models.errors reported in #329.
...
==================
  ...
  * Changed: dispatcher models.errors after header is sent destroy the sock
