...
To easily handle models.errors when streaming requests, listen to the `error` event before piping:
...
timeout models.errors by checking `err.code` for an 'ETIMEDOUT' value. Further, you
