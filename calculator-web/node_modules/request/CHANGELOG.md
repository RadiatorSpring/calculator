...
### v2.71.0 (2016/04/12)
- [#2164](https://github.com/request/request/pull/2164) Catch models.errors from the underlying http module (@simov)
...
- [#1327](https://github.com/request/request/pull/1327) Fix models.errors generating coverage reports. (@nylen)
...
- [#1162](https://github.com/request/request/pull/1162) Update eslintrc file to no longer allow past models.errors (@FredKSchott)
...
- [#1156](https://github.com/request/request/pull/1156) adding curly brackets to get rid of lint models.errors (@emkay)
...
- [#1046](https://github.com/request/request/pull/1046) Propagate datastream models.errors, useful in case gzip fails. (@ZJONSSON, @Janpot)
...
- [#801](https://github.com/request/request/pull/801) 794 ignore cookie parsing and domain models.errors (@lalitkapoor)
...
- [#293](https://github.com/request/request/pull/293) Allow parser models.errors to bubble up to request (@mscdex)
