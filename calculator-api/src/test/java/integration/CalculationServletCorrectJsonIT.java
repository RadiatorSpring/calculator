...
public class CalculationServletCorrectJsonIT {
    ...
    public void testForCorrectInput() throws IOException {
        HttpUriRequest request = new HttpGet("http://localhost:8080/api/v1/calculate?expression=1-1");
        ...
        assertEquals("status code for bad request", 200, response.getStatusLine().getStatusCode());
